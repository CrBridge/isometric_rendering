...
pub fn generate_noisemap(map_size: i32, seed: u32, scale: f64, low_threshold: f64, high_threshold: f64) -> Vec<Tile> {
    ...
    for y in 0..map_size {
        for x in 0..map_size {
            ...
            let grid_value = if normalized_value < low_threshold { 0 } else if normalized_value > high_threshold { 1 } else { 2 };
